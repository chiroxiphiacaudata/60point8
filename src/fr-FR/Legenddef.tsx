      ...
      >
        <Fade in={open}>
          <Box sx={style}>
            ...
            <Typography>
             Les arbres sont définis comme des végétaux d'une hauteur supérieure à 5 mètres. La "perte de couverture forestière" se définit comme une perturbation qui remplace un peuplement ou un passage d'un état forestier à un état non forestier. L'alerte à la déforestation indique une zone de 30 mètres carrés qui a subi une perturbation dans le couvert forestier, ce qui indique que des arbres dans cette zone peuvent avoir été perdus ou enlevés.<br /><br />Source: Hansen/UMD/Google/USGS/NASA, Hansen, Matthew C., Alexander Krylov, Alexandra Tyukavina, Peter V. Potapov, Svetlana Turubanova, Bryan Zutta, Suspense Ifo, Belinda Margono, Fred Stolle, and Rebecca Moore. “Humid Tropical Forest Disturbance Alerts Using Landsat Data.” Environmental Research Letters 11, no. 3 (2016): 034008
            </Typography>
          </Box>
        </Fade>
      </Modal>
