    ...
    return (
        ...
        <>
            ...
            <CardContent sx={{ maxWidth: 300 }}>
                <Typography component='div' className="titleh2" sx={{ mt: 2 }}>FORTRESS CONSERVATION
                    <Typography component='div' className="notemap" sx={{ mt: 2 }}><a href='https://www.alessandromusetta.com/geo/tiles/60point8/fence/map.html' target='_blank' rel='noopener noreferrer'>Open the interactive map</a></Typography>
                </Typography>
            </CardContent>
